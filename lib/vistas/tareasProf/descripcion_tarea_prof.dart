...
class DescripcionTareaProfWidget extends StatefulWidget {

  final int _idTarea;
  final Usuarios _idUsuario;

  DescripcionTareaProfWidget(this._idTarea,this._idUsuario);

  @override
  _DescripcionTareaProfWidgetState createState() =>
      _DescripcionTareaProfWidgetState(this._idTarea,this._idUsuario);
}

class _DescripcionTareaProfWidgetState extends StateMVC {
  ...
  _DescripcionTareaProfWidgetState(this._idTarea,this._idUsuario): super(Controller()){
    _con = Controller.con;
  }
  Controller _con;
                        ...
                        Expanded(
                          child: ListView(
                            children: [
                              ...
                              snapshot.data.imagenes.length > 0  && snapshot.data.tipo == tipoTarea.FIJA?
                              Container(
