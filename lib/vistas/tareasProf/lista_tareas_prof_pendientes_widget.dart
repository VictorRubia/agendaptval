...
class ListaTareasProfPendientesWidget extends StatefulWidget {
  const ListaTareasProfPendientesWidget({Key key}) : super(key: key);



  @override
  _ListaTareasProfPendientesWidgetState createState() => _ListaTareasProfPendientesWidgetState();
}

class _ListaTareasProfPendientesWidgetState extends StateMVC {
  ...
  _ListaTareasProfPendientesWidgetState(): super(Controller()){
    _con = Controller.con;
  }
  Controller _con;
  ...
  void initState() {
    ...
    // initial load
    tareas = _con.getTareasDeTuteladosEnProgresoProfesor();
              ...
              onTap: () async {
                isDialOpen.value = false;
                    await Navigator.push(
                      context,
                      MaterialPageRoute(
                        builder: (context) => AsignarTareaProfWidget(),
                      ),
                    ).then((_) => _onRefresh());
              }
          ),
          SpeedDialChild(
              ...
              onTap: () async {
                ...
                await Navigator.push(
                  context,
                  MaterialPageRoute(
                    builder: (context) => CrearTareaProfWidget(),
                  ),
                ).then((_) => _onRefresh());;
              }
          ),
