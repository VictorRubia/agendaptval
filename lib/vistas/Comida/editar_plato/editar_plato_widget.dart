...
class EditarPlatoWidget extends StatefulWidget {
  const EditarPlatoWidget({Key key}) : super(key: key);

  @override
  _EditarPlatoWidgetState createState() => _EditarPlatoWidgetState();
}

class _EditarPlatoWidgetState extends State<EditarPlatoWidget>
