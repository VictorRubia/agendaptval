...
import '../postre/postre_widget.dart';
import '../primer_plato/primer_plato_widget.dart';
import 'package:flutter/material.dart';
import 'package:font_awesome_flutter/font_awesome_flutter.dart';
import 'package:google_fonts/google_fonts.dart';
import '../../homepage/alumnos/home_page_alu_widget.dart';

class SegundoPlatoWidget extends StatefulWidget {
  const SegundoPlatoWidget({Key key}) : super(key: key);

  @override
  _SegundoPlatoWidgetState createState() => _SegundoPlatoWidgetState();
}

class _SegundoPlatoWidgetState extends State<SegundoPlatoWidget> {
