...
class AnadirPlatoWidget extends StatefulWidget {
  const AnadirPlatoWidget({Key key}) : super(key: key);

  @override
  _AnadirPlatoWidgetState createState() => _AnadirPlatoWidgetState();
}

class _AnadirPlatoWidgetState extends State<AnadirPlatoWidget>
